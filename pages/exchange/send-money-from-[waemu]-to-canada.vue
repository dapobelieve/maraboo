<template>
  <div>
    <div
      class="bg-[#BEBAFC] min-h-screen px-5 sm:px-5 lg:px-10"
        ...
        <div class="rounded-[30px] flex md:py-14 py-8 lg:px-8 justify-center">
          <div class="max-w-7xl w-full md:space-y-0 space-y-8 md:flex">
            <div class="md:w-1/2 text-white flex flex-col justify-between">
              ...
              >
                Send money from {{ countryName }} to Canada at the real exchange
                rate!
              </h1>
                  ...
                  <div class="block -mt-8">
                    <div class="ml-2 inline-flex flex-col">
                      <span
                        >&#x2022;
                        {{
                          $t("home.section5.how-it-works.step-3.cad-in.interac")
                        }}</span
                      >
                    </div>
                  </div>
...
const countryName = waemu.charAt(0).toUpperCase() + waemu.slice(1);
