<template>
    ...
    <section class="mt-[3rem] px-12 md:px-2 lg:px-12 pb-12 md:mt-[7rem] md:pb-32">
      <div class="md:flex gap-10">
        ...
        <div class="block mx-auto lg:flex items-center justify-center w-[80%] md:w-[500px] lg:w-2/4">
          <img class="h-full w-full content-center" src="~/assets/images/iphone-hexagon-2.png" />
        </div>
