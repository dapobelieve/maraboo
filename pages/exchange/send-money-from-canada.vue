<template>
  <main class="text-black">
      ...
      <div class="container">
        <div class="row justify-between space-y-8 md:flex md:space-y-0">
          <div class="text-white md:max-w-xs">
            <h1 class="display-2 mb-4 text-center">Two-way Corridors</h1>
            <p class="hidden text-center md:text-left">
              Send money to or from any UMOA country in real time at the lowest
              rate
            </p>
          </div>
          <div class="">
    ...
    <section>
      <div class="container">
        <div class="flex justify-between md:grid-cols-2">
      ...
      <div class="container">
        <div class="relative">
          ...
          <div class="flags mt-12 flex w-full items-center">
            <div class="grid grid-cols-4 gap-10 md:w-5/6">
              <CountryComponent
                class="shrink-0"
