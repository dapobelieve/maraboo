<template>
  <div>
    <div
      class="bg-[#BEBAFC] lg:px-[0px] min-h-screen"
        ...
        <div class="rounded-[30px] flex md:py-14 py-8 lg:px-8 justify-center">
          <div class="max-w-7xl w-full md:space-y-0 space-y-8 md:flex">
            <div class="md:w-1/2 text-white flex flex-col justify-between">
              ...
              >
                Send money from Canada to {{ selectedCountry }} at the real
                exchange rate!
              </h1>
    ...
    >
      <h1 class="mb-7 font-heading text-4xl md:text-6xl">
        From Canada to {{ selectedCountry }}, with 3x the cost efficiency
      </h1>
      <p class="text leading-relaxed lg:px-12">
        Maraboo is your wallet’s new superpower for international transfers from
        any WAEMU country.
        <span class="underline"
          >Send up to $9,900 daily at the Real Exchange</span
        >
        to pay international bills, tuition, suppliers, you name it! We accept
        XOF payments by mobile money transfers or by processing your back card
        <!-- <br />
        ...
        <div class="w-full mx-auto mb-8">
          ...
          >
            ...
            <div class="inline-flex flex-col mt-6">
              ...
              <span
                >&#x2022; Pay in any currency that we support (XOF or CAD)</span
              >
            </div>
          </div>
        </div>
        <div class="w-full">
          <div class="flex justify-center">
            ...
            >
              ...
              <p class="mb-3 mt-6">Your recipient receives money:</p>
              <div>
                <div class="mb-5">
                  ...
                  <div class="block">
                    <div class="ml-2 mt-2 inline-flex flex-col">
                      ...
                      <span
                        >&#x2022;
                        {{
                          $t("home.section5.how-it-works.step-3.xof-in.instant")
                        }}</span
                      >
  ...
  <section class="mt-[3rem] px-12 md:px-2 lg:px-12 pb-12 md:mt-[7rem] md:pb-32">
    <div class="md:flex gap-10">
      ...
      <div
        class="block mx-auto lg:flex items-center justify-center w-[80%] md:w-[500px] lg:w-2/4"
      >
        <img
