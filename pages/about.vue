<template>
  <main class="text-black">
          ...
          >
            <div class="remittances space-y-12">
              <h1 class="display-3 text-center md:text-left">
                {{ $t("about-us.section2.caption") }}
              </h1>
              <div>
                <p class="text-2 text-center md:text-left">
                  {{ $t("about-us.section2.text") }}
                </p>
              </div>
            </div>
    ...
    <section
      class="relative bg-[url('/assets/images/bdox.svg')] bg-cover"
      style="padding: 0"
    >
      <img
        ...
        alt=""
      />
      <div class="containesr absolute bottom-0 left-0 px-4">
