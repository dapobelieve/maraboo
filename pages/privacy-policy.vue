<template>
  <div class="items-baseline gap-5 text-black lg:flex">
    <!-- headings  -->
    <div class="px-5 lg:hidden">
      <h2 class="font-heading text-3xl font-semibold leading-9">
        Privacy Policy
      </h2>
      <p class="font-semibold leading-6">Last updated: October 27th, 2023</p>
    </div>

    <div id="toc" class="lg:fixed lg:max-w-[30%]">
      <TableOfContent :tocs="privacyPolicyToc" />
    </div>
    <div class="px-5 lg:ml-auto lg:w-[65%]">
      <div class="mb-20 mt-10 hidden lg:block">
        <h2 class="font-heading text-6xl font-semibold leading-[73px]">
          Privacy Policy
        </h2>
      ...
      <!-- intro  -->
      <div class="mb-10 leading-7 lg:mb-20 lg:text-xl lg:leading-8" id="intro">
        <h2
          class="font-heading mb-5 text-2xl font-semibold leading-8 lg:text-[40px] lg:leading-[48px]"
        >
          Introduction
        </h2>
        <div>
          <p class="mb-5">
            Grand Maraboo Technologies Limited, a Canadian corporation (the
            “<strong>Company</strong>” or “<strong>we</strong>”,
            “<strong>our</strong>”) respects your privacy and is committed to
            protecting it by complying with this policy.
          </p>
          <div class="mb-5">
            <p>This policy describes:</p>
            <ul
              class="pl-12 lg:leading-9"
              style="line-height: 30px; list-style-type: disc"
            >
              <li class="mb-3">
              ...
              <li class="mb-3">
                ...
                https://mara.boo/en (our “<strong>Site</strong>”).
              </li>
              <li>
          ...
          <div class="mb-5">
            ...
            <ul class="pl-12 pt-2 lg:leading-9" style="list-style-type: disc">
              ...
              <li>
                Through mobile and desktop application you download, which
          ...
          <div>
            <p class="mb-5">
              The Site may include links to third-party websites, plug-ins,
            ...
            <p>
              ...
              your choice is not to use our Site. By accessing or using this
              Site, you indicate that you understand, accept, and consent to the
              practices described in this policy. This policy may change from
              time to time (see
              <a
                @click="scrollToSection('#changes-to-policies')"
                class="cursor-pointer underline"
                >Changes to Our Privacy Policy</a
              >). Your continued use of this Site after we make changes
      ...
      <!-- info we collect  -->
      <div
        class="mb-10 leading-7 lg:mb-20 lg:text-xl lg:leading-8"
        id="info-we-collect"
      >
        <h2
          class="font-heading mb-5 text-2xl font-semibold leading-8 lg:text-[40px] lg:leading-[48px]"
        ...
        <div>
          ...
          <ul class="pl-12 lg:leading-9" style="list-style-type: disc">
            <li class="mb-3">
              <strong>Personal information</strong>, that we can reasonably use
              to directly or indirectly identify you, such as your name, mailing
              address, e-mail address, telephone number, Internet protocol (IP)
              address used to connect your computer to the Internet, location,
              device, user name or other similar identifier, billing and account
              information, social insurance number, date of birth, and any other
              identifier we may use to contact you (“<strong
                >personal information </strong
              >”).
            </li>
            <li class="mb-3">
              We provide an opportunity for any user to unsubscribe from our
              services or opt-out of contact for marketing purposes on an
              ongoing basis by accessing our Site, using the unsubscribe
              mechanism at the bottom of our e-mails.
            </li>
            <li class="mb-3">
              <strong>Supplemental identification information</strong>, such as
              supplemental identification information, such as government-issued
              identity documents, taxpayer identification number or national
              insurance number, and employment information.
            </li>
            <li class="mb-3">
              <strong>Non-personal information</strong>, that does not directly
              or indirectly reveal your identity or directly relate to an
              identifiable individual, such as demographic information, or
              statistical or aggregated information. Statistical or aggregated
              data does not directly identify a specific person, but we may
              derive non-personal statistical or aggregated data from personal
              information. For example, we may aggregate personal information to
              calculate the percentage of users accessing a specific Site
              feature.
            </li>
            <li class="mb-3">
              <strong>Financial information</strong>, including income/wealth
              verification documents or bank account statements.
            </li>
            <li class="mb-3">
              <strong>Technical information</strong>, including your login
              information, browser type and version, time zone setting, browser
              plug-in types and versions, operating system and platform, or
              information about your internet connection, the equipment you use
              to access our Site, and usage details.
            </li>
            <li class="mb-3">
              <strong>Transaction information</strong>, including information
              related to the use of the Services, types of Services requested,
              dates and times of such requests, payment methods, the name of the
              sender, the name of the recipient, and other similar information.
            </li>
            <li class="mb-3">
              <strong>Communication data</strong>, including messages, comments,
              or file transmissions.
            </li>
            <li class="mb-3">
              <strong>Non-personal details about your Site interactions </strong
      ...
      >
        ...
        <div>
          ...
          <ul class="pl-12 lg:leading-9" style="list-style-type: disc">
            <li class="mb-3">
              <strong
                >Direct interactions with you when you provide it to us</strong
              >, for example, by filling in forms, submitting content to the
              Site, like reviews, messages, or comments, or corresponding with
              us by phone, email, or otherwise.
            </li>
            <li class="mb-3">
              <strong>User contributions</strong>. You may also provide
              information for us to publish or display on public Site areas or
              transmit to other Site users or third parties.
            </li>
            <li class="mb-3">
              <strong>Automated technologies or interactions</strong>, as you
              navigate through our Site. Information collected automatically may
              include usage details, IP addresses, and information collected
              through cookies, web beacons, and other tracking technologies.
            </li>
            <li class="mb-3">
              <strong>Third parties or publicly available sources</strong>, for
              example, our business partners.
            </li>
            <li class="mb-3">
              <strong>Register online</strong> or place an order for any of our
              products or services.
            </li>
            <li class="mb-3">
              <strong>Voluntarily complete a customer survey</strong> or provide
              feedback on any of our message boards or via email.
            </li>
            <li class="mb-3">
              <strong>Download or use</strong> any of the Company’s mobile and
              desktop applications you download.
            </li>
            <li class="mb-3">
              <strong>
                Enable access to its device’s location tracking
                functionality</strong
              >, whether the Site or any mobile or desktop application you
              download is running in the foreground or background. Certain
              functionality may be affected while location data is turned off.
            </li>
          </ul>
        </div>
        <div class="mb-5">
          <h4 class="mb-5 text-xl font-semibold lg:text-2xl lg:leading-9">
          ...
          <div>
            ...
            <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
              <li class="mb-3">
                Information that you provide by filling in forms on our Site.
                This includes information provided at the time of registering to
                use our Site, subscribing to our service, posting material, or
          ...
          <div class="mt-5" id="info-we-collect-through-cookies">
            ...
            <div>
              <p class="mb-5">
                ...
                cookies or other automatic data collection technologies to
              ...
              <p class="mb-5">
                ...
                does not include personal information, and we may maintain it or
                associate it with personal information we collect in other ways,
                that you provide to us, or receive from third parties. It helps
                us to improve our Site and to deliver a better and more
              ...
              <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
                ...
                <li class="mb-3">
                  <strong>Web Beacons.</strong> Pages of our Site and our
                  e-mails may contain small electronic files known as web
      ...
      >
        ...
        <div>
          ...
          <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
            ...
            <li class="mb-3">
              To fulfill the purposes for which you provided the information or
              that were described when it was collected, or any other purpose
            ...
            <li class="mb-3">
              ...
              any contracts with you, including for billing and collection or to
            ...
            <li class="mb-3">
              To improve our Site, products or services, marketing, or customer
              relationships and experiences.
            </li>
            <li class="mb-3">
              To allow you to participate in interactive features, social media,
              or similar features on our Site.
            </li>
            <li class="mb-3">
            ...
            <li class="mb-3">
              ...
              including by protecting you and the Company from errors,
              misrepresentations, fraud, and/or contraventions of laws or
              criminal activity.
            </li>
          ...
          <p class="mb-5">
            ...
            third-parties’ goods and services, as permitted by law. If you do
            not want us to use your information in this way, please do not use
            the Site and please use the unsubscribe mechanism at the bottom of
            our e-mails. For more information, see
            <a
              @click="scrollToSection('#choices')"
              class="cursor-pointer underline"
              >Choices About How We Use and Disclose Your Information</a
        ...
        <div>
          ...
          <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
            ...
            <li class="mb-3">
              ...
              personal information held by the Company about our customers and
              users is among the assets transferred.
            </li>
            <li class="mb-3">
              To advertisers and advertising networks that require the
              information to select and serve relevant advertisements to you and
              others.
            </li>
            <li class="mb-3">
            ...
            <li class="mb-3">
              ...
              to support our business (such as analytics and search engine
              providers that assist us with Site improvement and optimization)
              ...
              it to them, and to process the personal information with the same
          ...
          <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
            <li class="mb-3">
              ...
              to respond to any government or regulatory request, in accordance
              with applicable law.
            </li>
            <li class="mb-3">
              To enforce or apply our
              <NuxtLink class="underline" to="/terms-of-use"
      ...
      >
        ...
        <div>
          <p class="mb-5">
            ...
            Site improvement and optimization) and who are contractually
          ...
          <p class="mb-5">
            ...
            Company policies regarding service providers outside of Canada. See
            <a
              @click="scrollToSection('#contact-info')"
              class="cursor-pointer underline"
              >Contact Information and Challenging Compliance.</a
            >
          </p>
          <p class="mb-5">
            By submitting your personal information or engaging with the Site,
        ...
        <div>
          ...
          <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
            <li class="mb-3">
              ...
              that some parts of this Site may not be accessible or may not
              function properly. For more information about tracking
              technologies, see
              <a
                @click="scrollToSection('#info-we-collect-through-cookies')"
                class="cursor-pointer underline"
                >Information We Collect Through Cookies and Other Automatic Data
                Collection Technologies</a
              >.
            </li>
            <li class="mb-3">
              <strong>Promotional Offers from the Company.</strong> If you have
              opted in to receive certain emails from us but no longer wish to
              ...
              unsubscribe from our services or opt-out of contact for marketing
              purposes on an ongoing basis by accessing our Site, using the
              unsubscribe mechanism at the bottom of our e-mails. If we have
              sent you a promotional email, you may unsubscribe by clicking the
              unsubscribe link we have included in the email. This opt-out does
              not apply to information provided to the Company as part of
            ...
            <li class="mb-3">
              ...
              target-audience preferences, you can opt out by unsubscribe from
              our services or opt-out of contact for marketing purposes on an
              ongoing basis by accessing our Site, using the unsubscribe
              mechanism at the bottom of our e-mails.
            </li>
          </ul>
      ...
      >
        ...
        <div>
          <p class="mb-5">
            ...
            services of the Company. Users may provide consent to marketing and
      ...
      >
        ...
        <div>
          ...
          <p class="mb-5">
            ...
            person identification number for access to certain parts of our
            Site, you are responsible for keeping such password and personal
            identification number strictly confidential. We ask you not to share
            your password or personal identification number with anyone. We urge
            you to be careful about giving out information in public areas of
            the Site like message boards, which any Site visitor can view.
          </p>
          <p class="mb-5">
      ...
      <!-- access  -->
      <div class="mb-10 leading-7 lg:mb-20 lg:text-xl lg:leading-8" id="access">
        <h2
          class="font-heading mb-5 text-2xl font-semibold leading-8 lg:text-[40px] lg:leading-[48px]"
        >
        ...
        <div>
          <p class="mb-5">
            With your express permission, we may access your contact list on
            your mobile device so that you can identify your contacts on Maraboo
            to allow you to send money to friends and family on Maraboo by
            searching for their phone number, email address or username. We
            transmit and use this information to help you easily filter your
            friends on ‘Maraboo’ and to help you transact with your friends and
            contacts if you choose to connect your contact list information with
            your account. We only access your contact list information with your
            explicit permission. For example, when you provide us with
            information about your contacts, we may use it to let you know which
            of your contacts have also signed up for our services so you can
            send money to them for free and quicker. We will not send messages
            to your contacts or make use of the data for any other purpose.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <p class="mb-5">
            ...
            this Site or on or through any of its features/register on the Site,
            make any purchases through the Site, use any of the interactive or
            public comment features of this Site, or provide any information
            ...
            <strong
              ><a
                href="mailto:info@mara.boo?subject=Feedback&body=Hello"
                class="underline"
                >info@mara.boo</a
              >.</strong
            >
      ...
      >
        ...
        <div>
          ...
          <p class="mb-5">
            ...
            to be incorrect. We may charge you a fee to access your personal
            information, however, we will notify you of any fee in advance.
          </p>
          <p class="mb-5">
          ...
          <ul class="mb-5 pl-12 lg:leading-9" style="list-style-type: disc">
            ...
            <li class="mb-3">
              ...
              their personal information or confidential commercial information.
            </li>
            <li class="mb-3">
          ...
          <p class="mb-5">
            ...
            information provided, you may contact our [Privacy Officer/[Cheick
            Ouedraogo] at [cheick@mara.boo].
          </p>
          <p class="mb-5">
            ...
            or might have been copied or stored by other Site users.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <p class="mb-5">
            ...
            to provide you with a particular product or service. We will explain
      ...
      >
        ...
        <div>
          <p class="mb-5">
            The Site contains links to other websites. This Policy applies only
            to the Site. If you navigate to any other website from a link on the
            Site, you should review the privacy policy of such website.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p class="mb-5">
            ...
            visiting our Site and this privacy policy to check for any changes.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p class="mb-5"><strong>[Cheick Ouedraogo]</strong></p>
          <p class="mb-5"><strong>[info@mara.boo] </strong></p>
          <p class="mb-5">
            <strong>[and/or via our toll-free number: </strong> <br />54348658
          </p>
        </div>
      </div>
    </div>
